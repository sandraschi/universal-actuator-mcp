    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-white">Robotics Dashboard</h2>
                    <p className="text-slate-400">System overview and fleet status</p>
                </div>
            </div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <div className="ml-2 space-y-1">
                                    <p className="text-sm font-medium leading-none text-white">Patrol Route Alpha</p>
                                    <p className="text-xs text-slate-400">Unitree Go2 • Sector 4</p>
                                </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="ml-2 space-y-1">
                                    <p className="text-sm font-medium leading-none text-white text-opacity-50">Mapping Sequence</p>
                                    <p className="text-xs text-slate-500">Scout Mini • Queued</p>
                                </div>
                            </div>
                        </div>
                    </CardContent>
