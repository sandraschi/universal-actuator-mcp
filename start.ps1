...
uv run python -m universal_actuator_mcp.server_PortHelpers = Join-Path $PSScriptRoot 'scripts\PortHelpers.ps1'
...
# Package has no __main__.py; server entry is universal_actuator_mcp.server (see server.py if __name__ == "__main__")
$env:UA_SSE_PORT = "$BackendPort"
uv run python -m universal_actuator_mcp.server_PortHelpers) { . Param([switch]$Headless)
...
# Package has no __main__.py; server entry is universal_actuator_mcp.server (see server.py if __name__ == "__main__")
$env:UA_SSE_PORT = "$BackendPort"
uv run python -m universal_actuator_mcp.server_PortHelpers }
