...
4. Start the server:
   ...
   uv run uvicorn universal_actuator_mcp.server:app --port 10982
   ```
...
5. Open `http://localhost:10982` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/universal-actuator-mcp/issues) |
